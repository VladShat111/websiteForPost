"""
Django settings for websiteForPost project.
...
SECRET_KEY = '#qt=nz*9k&qx+#z*yi7xyg-z0l6yegkl^f7=2(jsm20$_4b7l)'
...
ROOT_URLCONF = 'websiteForPost.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'blogMAndB/templates')]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
